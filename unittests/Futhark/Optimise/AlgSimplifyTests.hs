module Futhark.Optimise.AlgSimplifyTests (tests) where
...
mkSuffConds' varinfo s r =
  case mkSuffConds e r' of
    ...
    Right sc -> sc
  where
    e = simplify (parseScalExp varinfo s) r'
    r' = instantiateRanges varinfo r
